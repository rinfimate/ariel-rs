...
// Try: only edgeMid has label dims, regular edges have NO dims
...
g.setEdge('PERSON','ADDRESS', {}, 'e1');  // NO label dims
g.setEdge('ADDRESS','CITY', {}, 'e2');    // NO label dims
layout(g);
console.log('ranksep=80, only edgeMid has label dims:');
