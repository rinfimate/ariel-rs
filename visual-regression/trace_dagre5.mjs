...
// Match our current Rust renderer params: RANKSEP=101, label only on edgeMid, sp1/sp2=0.1
...
// Use OUR entity widths (from Rust measure)
...
g.setEdge(sp1, sp2, {label:'is married to', width:77.031, height:21, labelpos:'c'}, 'cyc1');
